...
class TwoPhaseTimescaleIQL:
    def __init__(self, alpha_m, alpha_e, alpha_r, gamma_h, gamma_r, beta_r_0,
                 ...
                 zeta=1.0, xi=1.0, beta_r_initial=0.1, epsilon_h_initial=0.8):
        # Phase 1 parameters
        ...
        self.beta_r = beta_r_initial  # Current beta_r (starts at beta_r_initial, increases to beta_r_0)
        
        # Human exploration parameters
        self.epsilon_h_0 = epsilon_h_0  # Final epsilon_h for converged policy
        self.epsilon_h = epsilon_h_initial  # Initial epsilon_h (starts high, decreases to epsilon_h_0)
        
        self.G = G
        self.mu_g = mu_g
        self.p_g = p_g
        self.eta = eta
        self.epsilon_r = epsilon_r  # Use the value passed from main.py
        self.debug = debug
    ...
    def train_phase2(self, environment, phase2_episodes, render=False, render_delay=0):
        ...
        for episode in range(phase2_episodes):
            ...
            # Update beta_r: increase from initial value to beta_r_0
            progress = episode / max(phase2_episodes - 1, 1)
            initial_beta_r = 0.1  # Use the same initial value as set in constructor
            self.beta_r = initial_beta_r + (self.beta_r_0 - initial_beta_r) * progress
